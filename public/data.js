const REELS_DATA = [
  ...
  },
  {
    ...
    "description_kr": "뻔하고 오글거릴 때 'corny'라고 해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "재미없다",
      "오글거리다",
  ...
  },
  {
    ...
    "expression_meaning_kr": "약속을 취소하다",
    "situation_kr": "약속을 취소할 때",
    "description_kr": "친구와의 약속을 지키지 못할 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "약속",
      "취소",
  ...
  {
    "id": 5,
    "expression_en": "Sounds fair enough",
    "expression_meaning_kr": "일리 있다",
    "situation_kr": "완전 동의하지 않을 때",
    "description_kr": "상대방의 의견에 부분적으로 동의할 때 사용해요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "동의",
      "의견",
  ...
  },
  {
    ...
    "expression_meaning_kr": "소중히 여겨라",
    "situation_kr": "중요한 순간에 결정을 내릴 때",
  ...
  {
    "id": 7,
    "expression_en": "I'm in my prime",
    "expression_meaning_kr": "전성기다",
    "situation_kr": "과거의 좋은 시절을 회상할 때",
    "description_kr": "전성기를 이야기할 때 자주 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "전성기",
      "좋은 시절",
  ...
  },
  {
    ...
    "expression_meaning_kr": "비교가 안 된다",
    "situation_kr": "게임이 안 될 때",
    "description_kr": "상대방의 실력을 압살할 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "비교",
      "실력 차이",
  ...
  },
  {
    ...
    "expression_meaning_kr": "몸이 무겁다",
    "situation_kr": "점심 후 몸이 무거울 때",
    "description_kr": "점심 먹고 나서 힘이 없을 때 쓰는 표현이야.",
    "category": "일상대화",
    "search_keywords_kr": [
      "컨디션",
      "몸무게",
  ...
  {
    "id": 10,
    "expression_en": "You're good",
    "expression_meaning_kr": "괜찮아",
    "situation_kr": "상태를 물어볼 때",
    "description_kr": "상대방의 상태를 확인할 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "상태",
      "괜찮다",
  ...
  {
    "id": 11,
    "expression_en": "I plead the fifth",
    "expression_meaning_kr": "묵비권 행사",
    "situation_kr": "곤란한 질문을 받을 때",
    "description_kr": "어색한 질문을 피하고 싶을 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "곤란한 질문",
      "묵비권",
  ...
  {
    "id": 12,
    "expression_en": "skin issue",
    "expression_meaning_kr": "피부 문제",
    "situation_kr": "피부 관련 대화를 할 때",
    "description_kr": "'피부 트러블' 대신 'skin issue'를 써보세요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "피부",
      "트러블",
  ...
  },
  {
    ...
    "expression_meaning_kr": "집에 있다",
    "situation_kr": "집에서 시간을 보낼 때",
    "description_kr": "외출하지 않고 집에서 쉬고 싶을 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "집콕",
      "집에서",
  ...
  {
    "id": 14,
    "expression_en": "Hang in there",
    "expression_meaning_kr": "조금만 버텨",
    "situation_kr": "힘든 상황에서 응원할 때",
    "description_kr": "힘든 상황에서 친구를 격려할 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "응원",
      "격려",
  ...
  {
    "id": 15,
    "expression_en": "That's kind of the whole point",
    "expression_meaning_kr": "그게 요점이야",
    "situation_kr": "상황을 확인하고 싶을 때",
    "description_kr": "이 표현은 어떤 상황의 본질을 강조할 때 사용해요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "요점",
      "상황",
  ...
  },
  {
    ...
    "expression_meaning_kr": "인기 폭발하다",
    "situation_kr": "SNS에서 인기 있을 때",
    "description_kr": "SNS에서 콘텐츠가 빠르게 퍼질 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "바이럴",
      "SNS",
  ...
  {
    "id": 17,
    "expression_en": "I can see your inside",
    "expression_meaning_kr": "속마음을 꿰뚫다",
    "situation_kr": "친구의 속마음을 알 때",
    "description_kr": "친구의 진짜 마음을 알 때 쓰는 표현이야.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "속마음",
      "친구",
  ...
  {
    "id": 18,
    "expression_en": "Not the most",
    "expression_meaning_kr": "그다지 좋지 않음",
    "situation_kr": "부정적인 표현을 피하고 싶을 때",
    "description_kr": "bad이나 boring 대신에 사용할 수 있어요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "부정적 표현",
      "부드럽게 말하기",
  ...
  {
    "id": 19,
    "expression_en": "fly all the way",
    "expression_meaning_kr": "멀리 날아가다",
    "situation_kr": "여행할 때",
    "description_kr": "멀리서 왔다는 걸 강조할 때 사용해요.",
    "category": "여행·외출",
    "search_keywords_kr": [
      "비행기",
      "여행",
  ...
  {
    "id": 20,
    "expression_en": "We're expecting a baby",
    "expression_meaning_kr": "아기를 기다린다",
    "situation_kr": "임신 소식을 전할 때",
    "description_kr": "기쁜 소식을 친구에게 전할 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "임신",
      "아기",
  ...
  },
  {
    ...
    "description_kr": "영어 공부에 대한 긍정적인 감정을 표현할 때 써요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "영어 공부",
      "즐기다",
  ...
  },
  {
    ...
    "description_kr": "상대방의 의견에 동의할 때 유용한 표현이에요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "인정",
      "타당",
  ...
  },
  {
    ...
    "description_kr": "상대방에게 상처를 줄 수 있는 감정이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "무관심",
      "감정",
  ...
  },
  {
    ...
    "description_kr": "돈을 차근차근 모을 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "저축",
      "돈 모으기",
  ...
  },
  {
    ...
    "description_kr": "사진이 유독 잘 나오는 사람이나 장소를 표현할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "사진",
      "잘 나오는",
  ...
  },
  {
    ...
    "description_kr": "상황 전환 시 자연스럽게 쓸 수 있어요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "영어 표현",
      "대화 전환",
  ...
  },
  {
    ...
    "description_kr": "새해에 이루고 싶은 목표를 정할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "신년",
      "계획",
  ...
  },
  {
    ...
    "description_kr": "미국에서 인기 있는 술게임이에요. 친구들과 즐겨보세요!",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "술게임",
      "진실게임",
  ...
  },
  {
    ...
    "description_kr": "누구나 따라 할 수 있는 완벽한 방법을 말해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "완벽한",
      "실패 없는",
  ...
  },
  {
    ...
    "description_kr": "자신의 판단에 의문을 가질 때 유용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "착각",
      "의심",
  ...
  },
  {
    ...
    "description_kr": "상대의 슬픔에 공감할 때 쓰는 표현이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "슬픔",
      "위로",
  ...
  },
  {
    ...
    "description_kr": "긍정적인 변화가 있을 때 쓰는 표현이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "믿기지 않다",
      "긍정적 변화",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 모든 요구 사항을 만족할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "조건",
      "만족",
  ...
  },
  {
    ...
    "description_kr": "Notice는 누군가의 변화를 부드럽게 언급할 때 유용해요!",
    "category": "일상대화",
    "search_keywords_kr": [
      "알아차리다",
      "변화",
  ...
  },
  {
    ...
    "description_kr": "문제를 해결하거나 감정을 파악할 때 유용한 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "문제 해결",
      "감정 파악",
  ...
  },
  {
    ...
    "description_kr": "좋은 일이 계속될 때 불안한 말을 피할 때 써요.",
    "category": "관용구·슬랭",
    "search_keywords_kr": [
      "징크스",
      "망치다",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 다양한 상황에서 쓰여요. 예를 들어, 가방을 내려놓을 때도 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "내려놓다",
      "가방",
  ...
  },
  {
    ...
    "description_kr": "편안한 분위기를 만들고 싶을 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "편안한",
      "느긋한",
  ...
  },
  {
    ...
    "description_kr": "다양한 상황에서 감정을 표현할 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "속상하다",
      "감정",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 감정 기복이 심한 사람을 설명할 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "감정 기복",
      "변덕",
  ...
  },
  {
    ...
    "description_kr": "상대의 선택에 동의하지 않을 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "선택 존중",
      "마음대로",
  ...
  },
  {
    ...
    "description_kr": "친구와 즐거운 시간을 보낼 때 자주 쓰는 표현이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "즐거운 시간",
      "신나는 활동",
  ...
  },
  {
    ...
    "description_kr": "자꾸 생각나는 노래를 설명할 때 써요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "중독성",
      "노래",
  ...
  },
  {
    ...
    "description_kr": "상대방과의 연락을 갑자기 끊을 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "연락 끊기",
      "잠수타다",
  ...
  },
  {
    ...
    "description_kr": "직설적으로 조용히 하라고 할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "닥치다",
      "조용히 해",
  ...
  },
  {
    ...
    "situation_kr": "공부할 때",
    "description_kr": "이 표현은 집중이 필요할 때 사용해요. 댓글로 퀴즈에 참여해보세요!",
    "category": "일상대화",
    "search_keywords_kr": [
      "집중",
      "포커스",
  ...
  },
  {
    ...
    "description_kr": "가장 좋은 경우를 말할 때 쓰는 표현이에요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "최고의 경우",
      "상황 가정",
  ...
  },
  {
    ...
    "description_kr": "즉흥적으로 음악이나 TV를 틀 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "즉흥",
      "음악",
  ...
  },
  {
    ...
    "description_kr": "단순한 “I want to tell you”보다 더 진심 있는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "중요한 이야기",
      "부드러운 전달",
  ...
  },
  {
    ...
    "description_kr": "긴장 풀고 마음껏 즐길 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "파티",
      "여행",
  ...
  },
  {
    ...
    "description_kr": "정중하게 모른다고 표현할 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "모르다",
      "정중한 표현",
  ...
  },
  {
    ...
    "description_kr": "잠시 집중력이 떨어지는 상태를 말해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "멍때리다",
      "집중력",
  ...
  },
  {
    ...
    "description_kr": "일상적인 상황에서 자주 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "괜찮니",
      "기분",
  ...
  },
  {
    ...
    "description_kr": "경기 중 선수 교체를 할 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "바톤",
      "터치",
  ...
  },
  {
    ...
    "description_kr": "대화 중에 가벼운 덧붙임으로 자주 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "대화",
      "전환",
  ...
  },
  {
    ...
    "description_kr": "내 말이 진짜임을 강조하고 싶을 때 사용해.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "진실",
      "강조",
  ...
  },
  {
    ...
    "description_kr": "예상과 다르게 일이 진행될 때 쓰는 표현이에요.",
    "category": "여행·외출",
    "search_keywords_kr": [
      "여행",
      "계획",
  ...
  },
  {
    ...
    "description_kr": "상대방의 거짓말을 처음부터 알았다는 의미야.",
    "category": "일상대화",
    "search_keywords_kr": [
      "거짓말",
      "즉시",
  ...
  },
  {
    ...
    "description_kr": "소음이나 불평으로 짜증날 때 쓰는 표현이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "소음",
      "짜증",
  ...
  },
  {
    ...
    "description_kr": "따뜻하게 공간으로 초대할 때 쓰는 표현이에요.",
    "category": "인사·소개",
    "search_keywords_kr": [
      "손님",
      "초대",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 두 가지 역할을 동시에 수행할 때 사용해요.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "N잡",
      "여러 역할",
  ...
  },
  {
    ...
    "description_kr": "상대방에게 미안함을 표현할 때 사용해요.",
    "category": "사과·감사",
    "search_keywords_kr": [
      "미안",
      "죄책감",
  ...
  },
  {
    ...
    "description_kr": "상황이 좋지 않더라도 긍정적인 면을 강조할 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "긍정적 표현",
      "영어 회화",
  ...
  },
  {
    ...
    "description_kr": "어떤 사람이나 사물에 대한 지지가 사라질 때 쓰는 표현이에요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "정치인",
      "여론",
  ...
  {
    "id": 65,
    "expression_en": "OCD (Obsessive Compulsive Disorder)",
    "expression_meaning_kr": "강박장애",
    "situation_kr": "OCD 의미를 설명할 때",
    "description_kr": "영어에서 자주 쓰이는 OCD의 정확한 의미와 사용법을 알아보세요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "강박",
      "OCD",
  ...
  {
    "id": 66,
    "expression_en": "Can't you tell? vs Can you tell?",
    "expression_meaning_kr": "모르겠어? vs 알겠어?",
    "situation_kr": "상대방에게 눈치를 물을 때",
    "description_kr": "can't you tell은 '티 안 나?', can you tell은 '알겠어?'로 뉘앙스가 달라요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "눈치",
      "티나다",
  ...
  },
  {
    ...
    "description_kr": "수업이나 중요한 일에 주의를 기울일 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "주의",
      "집중",
  ...
  },
  {
    ...
    "description_kr": "처음 만난 사람에게 반가움을 표현할 때 써요.",
    "category": "인사·소개",
    "search_keywords_kr": [
      "인사",
      "처음",
  ...
  },
  {
    ...
    "description_kr": "공부의 비례적 효과를 강조할 때 쓰는 표현이에요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "공부",
      "자신감",
  ...
  },
  {
    ...
    "description_kr": "존중을 표하면서 반대 의견을 말할 때 사용해요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "반대 의견",
      "존중",
  ...
  },
  {
    ...
    "description_kr": "상반된 두 가지를 비교할 때 유용해요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "비교",
      "상반된",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 힘든 순간까지도 함께하겠다는 의미예요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "결과",
      "상관없이",
  ...
  },
  {
    ...
    "description_kr": "부드럽게 거절할 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "거절",
      "취향",
  ...
  },
  {
    ...
    "description_kr": "한 팀이 모든 경기를 이겼을 때 쓰는 표현이에요.",
    "category": "관용구·슬랭",
    "search_keywords_kr": [
      "전승",
      "야구",
  ...
  },
  {
    ...
    "description_kr": "상대방의 말을 받아서 자연스럽게 대화할 때 유용해요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "회의",
      "발표",
  ...
  },
  {
    ...
    "description_kr": "배우는 과정에서 자연스럽게 익힐 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "배우다",
      "진행",
  ...
  },
  {
    ...
    "description_kr": "상대방에게 예의 있게 말을 꺼낼 때 유용해요.",
    "category": "요청·부탁",
    "search_keywords_kr": [
      "방해",
      "예의",
  ...
  },
  {
    ...
    "situation_kr": "용서할 때",
    "description_kr": "상대방을 이해하고 받아들일 때 쓰는 표현이에요.",
    "category": "사과·감사",
    "search_keywords_kr": [
      "용서",
      "사과",
  ...
  },
  {
    ...
    "description_kr": "지금 하고 있는 일을 설명할 때 자주 써요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "현재",
      "지금",
  ...
  },
  {
    ...
    "description_kr": "오늘 너무 힘들었어. 좀 늘어져야겠어.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "스트레스 해소",
      "편안함",
  ...
  },
  {
    ...
    "description_kr": "상황을 반대로 설명할 때 유용한 표현이에요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "반대",
      "상황",
  ...
  },
  {
    ...
    "description_kr": "상대방이 짜증날 정도로 자꾸 고칠 때 사용해요.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "잘난 척",
      "회의",
  ...
  },
  {
    ...
    "description_kr": "편안한 자세나 분위기를 표현할 때 사용해봐.",
    "category": "일상대화",
    "search_keywords_kr": [
      "편안한",
      "느긋한",
  ...
  },
  {
    ...
    "description_kr": "웃음이 폭발적으로 나올 때 쓰는 표현이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "웃음",
      "빵 터지다",
  ...
  },
  {
    ...
    "description_kr": "강한 감정 때문에 스스로 통제할 수 없을 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "어쩔 수 없어",
      "감정",
  ...
  },
  {
    ...
    "description_kr": "어떤 일이 잘 될지 확인하고 싶을 때 쓰는 표현이에요.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "테스트",
      "워터",
  ...
  },
  {
    ...
    "description_kr": "원어민들이 자주 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "기타",
      "등등",
  ...
  },
  {
    ...
    "description_kr": "더위를 식히고 싶을 때 자주 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "더위",
      "식히다",
  ...
  },
  {
    ...
    "description_kr": "혼자 남겨진 느낌을 표현할 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "소외감",
      "혼자",
  ...
  },
  {
    ...
    "description_kr": "머리카락이 가늘어질 때 사용할 수 있는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "탈모",
      "머리카락",
  ...
  },
  {
    ...
    "description_kr": "믿기 힘든 소식에 자주 쓰는 표현이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "놀라움",
      "소식",
  ...
  },
  {
    ...
    "description_kr": "상대방에게 잠시 시간을 요청할 때 쓰는 표현이에요.",
    "category": "요청·부탁",
    "search_keywords_kr": [
      "잠깐",
      "시간",
  ...
  },
  {
    ...
    "description_kr": "걷는 것으로 스트레스를 풀 수 있어요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "스트레스",
      "감정",
  ...
  },
  {
    ...
    "description_kr": "‘~면에서는’ 표현을 사용할 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "현명한",
      "시간",
  ...
  },
  {
    ...
    "description_kr": "'정신 차려'는 상황에 따라 다르게 쓸 수 있어요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "정신 차려",
      "집중",
  ...
  },
  {
    ...
    "description_kr": "비판할 때 조심스럽게 표현할 수 있어요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "필요 없다",
      "덜 필요",
  ...
  },
  {
    ...
    "description_kr": "기다림 끝에 말하는 ‘이제야!’의 뉘앙스.",
    "category": "일상대화",
    "search_keywords_kr": [
      "기다림",
      "전화",
  ...
  },
  {
    ...
    "description_kr": "친구의 제안에 자연스럽게 동의할 때 사용해보세요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "친구",
      "동의",
  ...
  },
  {
    ...
    "description_kr": "돈을 갚을 능력이 있음을 나타내는 표현이야.",
    "category": "일상대화",
    "search_keywords_kr": [
      "돈 갚다",
      "믿다",
  ...
  },
  {
    ...
    "description_kr": "상대방에게 더 이상 말하지 말라는 의미로 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "그만해",
      "말하지마",
  ...
  },
  {
    ...
    "description_kr": "상대방이 갑자기 연락을 끊을 때 쓰는 표현이에요.",
    "category": "관용구·슬랭",
    "search_keywords_kr": [
      "잠수",
      "연락 끊기",
  ...
  },
  {
    ...
    "description_kr": "상대방의 힘든 이야기에 공감할 때 자연스럽게 써봐.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "공감",
      "야근",
  ...
  },
  {
    ...
    "description_kr": "남자가 멋지게 입었을 때 칭찬할 때 써요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "옷 칭찬",
      "남자 옷",
  ...
  },
  {
    ...
    "description_kr": "부드럽게 지적하고 싶을 때 사용해보세요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "옷",
      "얼굴",
  ...
  },
  {
    ...
    "description_kr": "'explain'보다 부드러운 표현이에요. 상황에 맞게 써보세요!",
    "category": "일상대화",
    "search_keywords_kr": [
      "설명",
      "과정",
  ...
  },
  {
    ...
    "description_kr": "상대방의 말을 비꼬며 믿지 않을 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "비꼬다",
      "믿지 않다",
  ...
  },
  {
    ...
    "description_kr": "커피를 마신 직후의 기분을 표현해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "커피",
      "정신",
  ...
  },
  {
    ...
    "description_kr": "어떤 이유로 약속에 못 갔을 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "약속",
      "못 갔어요",
  ...
  },
  {
    ...
    "description_kr": "crave는 강한 욕망을 표현할 때 써요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "갈망",
      "욕구",
  ...
  },
  {
    ...
    "description_kr": "‘I’m lonely’는 깊은 외로움, ‘I feel lonely’는 순간 감정이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "외로움",
      "감정 표현",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 유감스럽지만 동의할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "유감",
      "동의",
  ...
  },
  {
    ...
    "description_kr": "행동으로 남에게 과시하는 사람을 가리킬 때 사용해요.",
    "category": "관용구·슬랭",
    "search_keywords_kr": [
      "과시",
      "잘난체",
  ...
  },
  {
    ...
    "description_kr": "일회용품을 설명할 때 자주 쓰는 표현이야.",
    "category": "일상대화",
    "search_keywords_kr": [
      "일회용품",
      "환경",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 오랜 실패를 끝내고 성공할 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "저주",
      "깨다",
  ...
  },
  {
    ...
    "description_kr": "미국에서는 MBTI 대신 별자리로 성격을 많이 봐요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "별자리",
      "성격",
  ...
  },
  {
    ...
    "description_kr": "사귀진 않지만 누군가와 데이트 중일 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "연애",
      "썸",
  ...
  },
  {
    ...
    "description_kr": "회의 중에 나중에 다시 이야기하자고 할 때 유용해요.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "회의",
      "비즈니스 영어",
  ...
  },
  {
    ...
    "description_kr": "회의에서 내 의견을 말할 때 쓰는 표현이에요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "회의",
      "의견",
  ...
  },
  {
    ...
    "description_kr": "외로움을 표현할 때 자연스럽게 쓸 수 있어요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "외로움",
      "감정 표현",
  ...
  },
  {
    ...
    "description_kr": "상대방의 동의를 구할 때 자연스럽게 사용해보세요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "영어 표현",
      "일상 대화",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 말을 하다가 정정하거나 강조할 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "정정",
      "강조",
  ...
  },
  {
    ...
    "situation_kr": "헤어질 때",
    "description_kr": "친구와 헤어질 때 자주 쓰는 표현이에요.",
    "category": "인사·소개",
    "search_keywords_kr": [
      "헤어질 때",
      "인사",
  ...
  },
  {
    ...
    "situation_kr": "발표할 때",
    "description_kr": "중요한 내용을 강조할 때 자연스럽게 써보세요!",
    "category": "의견·토론",
    "search_keywords_kr": [
      "발표",
      "중요한",
  ...
  },
  {
    ...
    "description_kr": "어린 시절의 생각이나 행동에서 벗어나는 과정을 표현해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "철이 든다",
      "성장",
  ...
  },
  {
    ...
    "description_kr": "'기본적으로'라는 뜻으로 문장 시작에 자주 써.",
    "category": "일상대화",
    "search_keywords_kr": [
      "기본적으로",
      "간단히",
  ...
  },
  {
    ...
    "description_kr": "단어에 less를 붙이면 반대 의미가 돼요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "부정",
      "접미사",
  ...
  },
  {
    ...
    "description_kr": "가족과 함께 의미 있는 시간을 보낼 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "가족",
      "시간",
  ...
  },
  {
    ...
    "description_kr": "미팅 중 누군가 연결이 끊겼을 때 사용할 수 있어요.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "연결 끊김",
      "미팅",
  ...
  },
  {
    ...
    "description_kr": "잼은 과일 잼과 교통체증 두 가지 의미로 쓰여요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "잼",
      "교통체증",
  ...
  },
  {
    ...
    "description_kr": "미팅이나 수업을 부드럽게 마무리할 때 유용해요.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "미팅 종료",
      "수업 마무리",
  ...
  },
  {
    ...
    "description_kr": "상대방에게 내 목소리가 잘 들리는지 물어볼 때 사용해요.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "소리 확인",
      "회의",
  ...
  },
  {
    ...
    "description_kr": "소리를 낮추거나 제안을 거절할 때 유용해요.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "거절하다",
      "소리 낮추다",
  ...
  },
  {
    ...
    "description_kr": "주어진 것들을 당연히 여기지 말고 감사하라는 뜻이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "감사",
      "당연",
  ...
  },
  {
    ...
    "description_kr": "안 좋은 상황에서도 긍정적으로 생각할 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "긍정적",
      "상황",
  ...
  },
  {
    ...
    "description_kr": "hustler는 사기꾼을 뜻하기도 해.",
    "category": "관용구·슬랭",
    "search_keywords_kr": [
      "사기꾼",
      "hustler",
  ...
  },
  {
    ...
    "description_kr": "다이어트를 하다가 포기할 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "포기하다",
      "다이어트",
  ...
  },
  {
    ...
    "description_kr": "목이 마른지 물어볼 때 쓰는 표현이야.",
    "category": "일상대화",
    "search_keywords_kr": [
      "목마르다",
      "물",
  ...
  },
  {
    ...
    "description_kr": "진짜로 진심을 표현하고 싶을 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "진심",
      "농담",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 정말 웃긴 상황에서 쓸 수 있어요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "웃다",
      "재미있다",
  ...
  },
  {
    ...
    "description_kr": "부당한 상황에서 자주 쓰는 표현이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "억울하다",
      "불공평",
  ...
  },
  {
    ...
    "situation_kr": "주차할 때",
    "description_kr": "주차할 때 벌금이 있다는 걸 알려주는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "주차",
      "벌금",
  ...
  },
  {
    ...
    "description_kr": "긍정적인 의미로 사용해요. 예를 들어 '꽤 괜찮은데?'",
    "category": "일상대화",
    "search_keywords_kr": [
      "예쁘다",
      "꽤",
  ...
  },
  {
    ...
    "description_kr": "Badass는 긍정적인 의미로도 많이 쓰여요.",
    "category": "관용구·슬랭",
    "search_keywords_kr": [
      "멋진",
      "위험한",
  ...
  },
  {
    ...
    "situation_kr": "시끄러울 때",
    "description_kr": "소음을 줄여달라고 할 때 쓰는 표현이에요.",
    "category": "요청·부탁",
    "search_keywords_kr": [
      "조용히",
      "소음",
  ...
  },
  {
    ...
    "description_kr": "식사 후 배가 부를 때 자연스럽게 사용할 수 있어요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "배부르다",
      "식사 표현",
  ...
  },
  {
    ...
    "description_kr": "'I'm immature'는 자신의 성숙하지 못한 면을 솔직하게 말할 때 써.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "미성숙",
      "어린애",
  ...
  },
  {
    ...
    "description_kr": "더 좋은 선택지를 제안할 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "더 나은",
      "상황 반응",
  ...
  {
    "id": 151,
    "expression_en": "I'm under a lot of stress",
    "expression_meaning_kr": "스트레스를 많이 받고 있어",
    "situation_kr": "스트레스 표현할 때",
    "description_kr": "'I have stress'가 아니라 'I'm under stress'가 자연스러운 표현이에요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "스트레스",
      "힘들다",
  ...
  },
  {
    ...
    "description_kr": "지루함을 표현할 때 자주 쓰는 말이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "지루하다",
      "감정 표현",
  ...
  {
    "id": 154,
    "expression_en": "affect vs effect",
    "expression_meaning_kr": "영향을 주다 vs 영향(결과)",
    "situation_kr": "헷갈리는 단어 구분할 때",
    "description_kr": "affect는 동사(영향을 주다), effect는 명사(결과)로 기억하세요!",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "영향",
      "헷갈리는",
  ...
  },
  {
    ...
    "description_kr": "놀라거나 혼란스러울 때 쓰는 표현이야.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "멘붕",
      "놀람",
  ...
  },
  {
    ...
    "description_kr": "더운 상황을 표현할 때 쓰는 말이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "더위",
      "덥다",
  ...
  {
    "id": 158,
    "expression_en": "What does she look like?",
    "expression_meaning_kr": "그녀는 어떻게 생겼어?",
    "situation_kr": "외모를 물어볼 때",
    "description_kr": "'How does she look?'은 컨디션을 묻는 말이에요. 외모는 'What does she look like?'이 맞아요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "외모",
      "생김새",
  ...
  {
    "id": 160,
    "expression_en": "farther vs further",
    "expression_meaning_kr": "더 먼(물리적) vs 더 나아가(추상적)",
    "situation_kr": "헷갈리는 단어 구분할 때",
    "description_kr": "물리적 거리는 farther, 추상적 의미는 further를 쓰세요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "거리",
      "멀다",
  ...
  },
  {
    ...
    "description_kr": "어떤 일에 집중하지 못하고 생각이 멀어질 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "집중",
      "멍",
  ...
  },
  {
    ...
    "description_kr": "자신의 의견을 조심스럽게 말할 때 유용해요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "정정",
      "의견",
  ...
  },
  {
    ...
    "description_kr": "확신이 없을 때 조심스럽게 말할 때 사용해요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "의견",
      "틀리다",
  ...
  },
  {
    ...
    "description_kr": "어떤 행동이 가끔 일어날 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "때때로",
      "가끔",
  ...
  },
  {
    ...
    "description_kr": "가끔씩 일어나는 일을 표현할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "가끔",
      "때때로",
  ...
  },
  {
    ...
    "description_kr": "마지막 차나 물건을 표현할 때 쓰는 단어예요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "마지막",
      "순서",
  ...
  },
  {
    ...
    "description_kr": "상대방의 말을 정확히 이해했는지 확인할 때 쓰는 표현이야.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "이해 확인",
      "대화 표현",
  ...
  },
  {
    ...
    "description_kr": "특별한 감사함을 표현할 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "감사",
      "표현",
  ...
  },
  {
    ...
    "description_kr": "전자와 후자를 구분할 때 자주 쓰는 단어예요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "전자",
      "후자",
  ...
  },
  {
    ...
    "description_kr": "영국과 미국에서 발음이 달라요. H를 발음하지 않아요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "허브",
      "발음",
  ...
  },
  {
    ...
    "description_kr": "afterworld는 사건이 직후에 일어날 때 쓰는 표현이야.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "after",
      "afterworld",
  ...
  },
  {
    ...
    "description_kr": "기간을 강조할 때 'good'을 사용해요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "좋은 4일",
      "기간 강조",
  ...
  },
  {
    ...
    "description_kr": "여러 가지 선택지 중에서 가장 좋은 것을 고를 때 유용해요.",
    "category": "관용구·슬랭",
    "search_keywords_kr": [
      "선택",
      "고르다",
  ...
  },
  {
    ...
    "description_kr": "엘리베이터 내부에 있을 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "엘리베이터",
      "영어 표현",
  ...
  },
  {
    ...
    "description_kr": "주문이 잘못됐을 때 부드럽게 설명할 때 써요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "주문",
      "잘못",
  ...
  },
  {
    ...
    "description_kr": "친구가 곁에 있다는 느낌을 표현할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "곁에",
      "친구",
  ...
  },
  {
    ...
    "description_kr": "일하기 싫을 때 이렇게 표현해보세요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "사무실",
      "일",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 혼자서 어떤 일을 했을 때 사용할 수 있어요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "혼자",
      "자립",
  ...
  },
  {
    ...
    "description_kr": "모든 상황이 잘 진행될 때 쓰는 표현이에요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "초록색",
      "순조롭다",
  ...
  },
  {
    ...
    "description_kr": "비닐하우스는 영어로 그린하우스라고 해요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "온실",
      "비닐하우스",
  ...
  },
  {
    ...
    "description_kr": "실패나 어려움 속에서도 긍정적인 면을 보자는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "긍정적",
      "실패",
  ...
  },
  {
    ...
    "description_kr": "자외선 차단제를 사용할 때 주로 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "선크림",
      "자외선",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 망설임 없이 즉시 행동할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "즉시",
      "바로",
  ...
  },
  {
    ...
    "description_kr": "아플 때 의사에게 가라고 할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "병원",
      "의사",
  ...
  },
  {
    ...
    "situation_kr": "친구에게 물어볼 때",
    "description_kr": "친구에게 가벼운 질문으로 왜 왔는지 물어보는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "왜 왔어",
      "어떻게 왔어",
  ...
  },
  {
    ...
    "description_kr": "무언가의 가능성을 고민할 때 자주 사용해요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "여부",
      "결정",
  ...
  },
  {
    ...
    "description_kr": "코인이 갑자기 큰 관심을 받을 때 사용할 수 있어요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "인기",
      "성공",
  ...
  },
  {
    ...
    "description_kr": "어떤 일을 할 때 최선을 다하겠다는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "최선",
      "노력",
  ...
  },
  {
    ...
    "description_kr": "죽이지 못하는 상태를 표현할 때 유용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "불사",
      "죽이지 못함",
  ...
  },
  {
    ...
    "description_kr": "추운 날씨에 몸을 따뜻하게 유지할 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "따뜻하다",
      "겨울",
  ...
  },
  {
    ...
    "description_kr": "매력적인 사람을 표현할 때 자주 쓰는 단어예요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "매력",
      "칭찬",
  ...
  },
  {
    ...
    "situation_kr": "격식 있는 자리에서",
    "description_kr": "공식적인 자리에서 사과할 때 유용해요.",
    "category": "사과·감사",
    "search_keywords_kr": [
      "사과",
      "공식적",
  ...
  },
  {
    ...
    "description_kr": "예상치 못한 상황을 표현할 때 유용해요!",
    "category": "일상대화",
    "search_keywords_kr": [
      "예상치 못한",
      "상황",
  ...
  },
  {
    ...
    "description_kr": "마니또와 같은 의미로, 비밀리에 선물을 주는 상황에서 사용해요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "마니또",
      "비밀",
  ...
  },
  {
    ...
    "description_kr": "가격이 하늘로 치솟을 때 쓰는 표현이에요.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "가격 급등",
      "영어 표현",
  ...
  },
  {
    ...
    "description_kr": "무언가가 매우 필요할 때 사용할 수 있어요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "절실하게",
      "매우",
  ...
  },
  {
    ...
    "description_kr": "늦는 상황에서 예의 있게 말할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "늦다",
      "약속",
  ...
  },
  {
    ...
    "situation_kr": "기다려줄 때",
    "description_kr": "누군가를 기다리게 할 때 정중하게 사용할 수 있어요.",
    "category": "요청·부탁",
    "search_keywords_kr": [
      "감사",
      "인내",
  ...
  },
  {
    ...
    "description_kr": "짧은 관계를 표현할 때 사용해요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "썸",
      "관계",
  ...
  },
  {
    ...
    "description_kr": "집주인을 영어로 표현할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "집주인",
      "영어 표현",
  ...
  },
  {
    ...
    "situation_kr": "결정을 내릴 때",
    "description_kr": "결정을 쉽게 못하는 사람을 표현할 때 써요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "결정장애",
      "결정",
  ...
  },
  {
    ...
    "description_kr": "친구나 연인에게 애정을 표현하고 싶을 때 쓰는 표현이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "애정",
      "표현",
  ...
  },
  {
    ...
    "description_kr": "가벼운 대화로 취미를 물어볼 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "취미",
      "대화",
  ...
  },
  {
    ...
    "description_kr": "1+1 행사에서 자주 쓰이는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "1+1",
      "할인",
  ...
  },
  {
    ...
    "description_kr": "진행 상황을 공유할 때 자주 쓰는 표현이에요.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "연락",
      "업무",
  ...
  },
  {
    ...
    "description_kr": "야식이 땡길 때 자연스럽게 쓸 수 있어요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "야식",
      "간식",
  ...
  },
  {
    ...
    "description_kr": "택시를 타고 주변 맛집을 물어볼 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "택시",
      "스몰토크",
  ...
  },
  {
    ...
    "description_kr": "할로윈에 어떤 캐릭터로 분장할지 말할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "할로윈",
      "분장",
  ...
  },
  {
    ...
    "description_kr": "맛있어서 믿기지 않을 때 쓰는 표현이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "진짜",
      "믿기지 않아",
  ...
  },
  {
    ...
    "description_kr": "면접에서 떨어졌다고 말할 때 쓸 수 있어.",
    "category": "일상대화",
    "search_keywords_kr": [
      "삼진",
      "실패",
  ...
  },
  {
    ...
    "description_kr": "자신의 취향이나 성격을 표현할 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "취향 표현",
      "자기소개",
  ...
  },
  {
    ...
    "description_kr": "영어로 약속을 표현할 때 사용해봐.",
    "category": "비즈니스",
    "search_keywords_kr": [
      "약속",
      "일정",
  ...
  },
  {
    ...
    "description_kr": "노벨상 수상 소식을 전할 때 유용해요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "노벨상",
      "수상",
  ...
  },
  {
    ...
    "description_kr": "음식의 강한 맛을 표현할 때 자주 쓰여요.",
    "category": "관용구·슬랭",
    "search_keywords_kr": [
      "킥",
      "강렬한 맛",
  ...
  },
  {
    ...
    "description_kr": "내가 한 말을 취소하고 싶을 때 쓰는 표현이야.",
    "category": "사과·감사",
    "search_keywords_kr": [
      "말 취소",
      "잘못된 말",
  ...
  },
  {
    ...
    "description_kr": "친구와 비용을 나눌 때 이 표현을 써보세요!",
    "category": "일상대화",
    "search_keywords_kr": [
      "비용 나누기",
      "영어 표현",
  ...
  },
  {
    ...
    "description_kr": "친구에게 도전할 때 응원하는 표현이에요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "응원",
      "도전",
  ...
  },
  {
    ...
    "description_kr": "어떤 일이 말로는 간단해 보일 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "쉽다",
      "간단하다",
  ...
  },
  {
    ...
    "description_kr": "친구에게 식사를 대접할 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "대접하다",
      "식사",
  ...
  },
  {
    ...
    "description_kr": "상대에게 감정을 표현할 때 쓰는 표현이야.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "고백",
      "사랑",
  ...
  },
  {
    ...
    "situation_kr": "부탁할 때",
    "description_kr": "누군가에게 도움을 요청할 때 쓰는 표현이에요.",
    "category": "요청·부탁",
    "search_keywords_kr": [
      "부탁",
      "호의",
  ...
  },
  {
    ...
    "description_kr": "extra는 추가로 필요한 것을 간편하게 표현할 때 써요.",
    "category": "요청·부탁",
    "search_keywords_kr": [
      "추가",
      "더 필요",
  ...
  },
  {
    ...
    "description_kr": "상황에 맞게 천천히 진행하라는 의미예요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "고백",
      "자신감",
  ...
  },
  {
    ...
    "description_kr": "차를 태워달라고 정중하게 물어볼 때 써요.",
    "category": "요청·부탁",
    "search_keywords_kr": [
      "태워주다",
      "차",
  ...
  },
  {
    ...
    "description_kr": "가까운 곳으로 이동할 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "가고 있어",
      "이동",
  ...
  },
  {
    ...
    "description_kr": "25세 전후에 인생의 방향을 고민할 때 쓰는 표현이에요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "25세",
      "위기",
  ...
  {
    "id": 228,
    "expression_en": "Happy Thanksgiving",
    "expression_meaning_kr": "추수감사절을 축하해요",
    "situation_kr": "미국 명절 문화 이해할 때",
    "description_kr": "미국의 추수감사절 문화를 이해하면 미국인과의 대화가 훨씬 자연스러워져요.",
    "category": "문화·뉘앙스",
    "search_keywords_kr": [
      "추수감사절",
      "명절",
  ...
  },
  {
    ...
    "description_kr": "더 공손하게 예약하고 싶을 때 사용해요.",
    "category": "여행·외출",
    "search_keywords_kr": [
      "호텔 예약",
      "공손한 표현",
  ...
  {
    "id": 230,
    "expression_en": "What was your first impression of SNU?",
    "expression_meaning_kr": "서울대 첫인상이 어땠어?",
    "situation_kr": "첫인상에 대해 물어볼 때",
    "description_kr": "외국인 유학생에게 서울대 첫인상을 묻는 인터뷰. 자연스러운 질문 표현을 배울 수 있어요.",
    "category": "인터뷰",
    "search_keywords_kr": [
      "첫인상",
      "서울대",
  ...
  },
  {
    ...
    "description_kr": "호텔에서 조식 시간을 물어볼 때 유용한 표현이에요.",
    "category": "여행·외출",
    "search_keywords_kr": [
      "호텔",
      "조식",
  ...
  },
  {
    ...
    "description_kr": "커피를 주문할 때 얼음을 적게 달라고 할 때 사용해요.",
    "category": "요청·부탁",
    "search_keywords_kr": [
      "커피",
      "주문",
  ...
  },
  {
    ...
    "description_kr": "상대방의 관심사를 공유할 때 유용한 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "관심사",
      "대화",
  ...
  },
  {
    ...
    "description_kr": "친구에게 편하게 이름을 소개할 때 유용해요.",
    "category": "인사·소개",
    "search_keywords_kr": [
      "자기소개",
      "이름",
  ...
  },
  {
    ...
    "description_kr": "부산의 매력을 간단히 표현할 수 있어요.",
    "category": "여행·외출",
    "search_keywords_kr": [
      "부산",
      "여행",
  ...
  },
  {
    ...
    "description_kr": "이 표현은 자주 가는 장소를 설명할 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "자주 가는 곳",
      "명소",
  ...
  },
  {
    ...
    "description_kr": "여행을 떠나는 친구에게 좋은 여행을 기원할 때 사용해요.",
    "category": "여행·외출",
    "search_keywords_kr": [
      "여행",
      "인사",
  ...
  {
    "id": 239,
    "expression_en": "Did you have any stereotypes?",
    "expression_meaning_kr": "편견이 있었어?",
    "situation_kr": "고정관념에 대해 이야기할 때",
    "description_kr": "외국인이 한국에 대해 가졌던 기대와 현실의 차이를 이야기하는 인터뷰예요.",
    "category": "인터뷰",
    "search_keywords_kr": [
      "편견",
      "고정관념",
  ...
  },
  {
    ...
    "description_kr": "좋은 의미와 나쁜 의미로 모두 쓸 수 있어요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "미치다",
      "스트레스",
  ...
  {
    "id": 242,
    "expression_en": "What stereotypes did you have?",
    "expression_meaning_kr": "어떤 고정관념이 있었어?",
    "situation_kr": "서울대생 고정관념을 물을 때",
    "description_kr": "서울대생에 대한 고정관념(smart, busy, productive)을 이야기하는 인터뷰예요.",
    "category": "인터뷰",
    "search_keywords_kr": [
      "서울대",
      "고정관념",
  ...
  },
  {
    ...
    "description_kr": "둘 다 별로일 때 쓰는 표현이야.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "둘 다 아니다",
      "선택",
  ...
  },
  {
    ...
    "description_kr": "운동 후 친구에게 칭찬할 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "몸",
      "운동",
  ...
  },
  {
    ...
    "description_kr": "상대방의 냄새가 심할 때 사용할 수 있어요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "냄새",
      "악취",
  ...
  {
    "id": 247,
    "expression_en": "Why did you come to Korea to teach English?",
    "expression_meaning_kr": "왜 한국에 와서 영어를 가르쳐?",
    "situation_kr": "한국에 온 이유를 물을 때",
    "description_kr": "한국에서 영어를 가르치는 외국인 교사와의 짧은 인터뷰예요.",
    "category": "인터뷰",
    "search_keywords_kr": [
      "한국",
      "영어교사",
  ...
  },
  {
    ...
    "description_kr": "생각나는 대로 행동하고 싶을 때 쓰는 표현이에요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "즉흥",
      "마음",
  ...
  },
  {
    ...
    "description_kr": "비슷한 사람에 대해 이야기할 때 사용해보세요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "비슷한 사람",
      "관계",
  ...
  },
  {
    ...
    "description_kr": "상대방과 다른 점이 더 재미있을 때 사용해보세요.",
    "category": "의견·토론",
    "search_keywords_kr": [
      "선호",
      "다른 사람",
  ...
  },
  {
    ...
    "situation_kr": "칭찬할 때",
    "description_kr": "누군가의 영어 실력을 칭찬할 때 사용해보세요.",
    "category": "감정·리액션",
    "search_keywords_kr": [
      "영어 칭찬",
      "영어 잘함",
  ...
  },
  {
    ...
    "description_kr": "모르는 내용을 간단히 표현할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "모르다",
      "대답",
  ...
  },
  {
    ...
    "description_kr": "상대방에게 미안한 말을 부드럽게 전할 때 사용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "미안하지만",
      "부드러운 표현",
  ...
  },
  {
    ...
    "description_kr": "별다른 이유 없이 그냥 하는 행동을 설명할 때 써요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "그냥",
      "이유",
  ...
  },
  {
    ...
    "description_kr": "궁금한 점을 부드럽게 물어볼 때 유용해요.",
    "category": "일상대화",
    "search_keywords_kr": [
      "궁금하다",
      "질문",
  ...
  },
  {
    ...
    "description_kr": "어려운 상황에서도 편안함을 느끼라는 의미야.",
    "category": "일상대화",
    "search_keywords_kr": [
      "불편함",
      "도전",
