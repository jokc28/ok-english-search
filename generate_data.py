...
for entry in entries:
    ...
    new_entry = {
        ...
        'expression_meaning_kr': e.get('expression_meaning_kr', '') or entry.get('expression_meaning_kr', ''),
        'situation_kr': e.get('situation_kr', '') or entry.get('situation_kr', ''),
        'description_kr': e.get('description_kr', '') or entry.get('description_kr', ''),
        'category': e.get('category', '') or entry.get('category', '일상대화'),
        'search_keywords_kr': e.get('search_keywords_kr', []) or entry.get('search_keywords_kr', []),
        'search_keywords_en': e.get('search_keywords_en', []) or entry.get('search_keywords_en', []),
        'difficulty': e.get('difficulty', '') or entry.get('difficulty', 'intermediate'),
        ...
        'quiz_sentence_en': e.get('quiz_sentence_en', ''),
        'quiz_sentence_confidence': 'review',
        'quiz_sentence_audit_note': 'Run npm run audit:targets to extract and validate a full quiz sentence.',
